...
project = 'platescheduler'
copyright = '{0}, {1}'.format('2020', 'John Donor')
author = 'John Donor'
...
.. |platescheduler_version| replace:: {__version__}
"""
...
htmlhelp_basename = '{0}pdoc'.format('platescheduler')
...
man_pages = [
    (master_doc, 'platescheduler', u'{0} Documentation'.format(project),
     [author], 1)
]
...
if use_releases == 'yes':
    ...
    releases_github_path = 'sdss/platescheduler'
